...
<body class="animsition">
	...
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url('<?php echo base_url('assets/images/menu.jpg'); ?>'); background-position: center;">
			...
			<div class="row">
				<div class="col-md-4 p-b-30">
					<div class="hov-img-zoom">
						<img src="<?php echo base_url('assets\images\menu.jpg');?>" alt="IMG-ABOUT">
					</div>
				</div>
				...
				<div class="col-md-8 p-b-30">
					...
					<div class="bo13 p-l-29 m-l-9 p-b-10">
						<p class="p-b-11">
							Le design est un dont que j'ai eu a developpe en deuxieme session apres
							avoir fait 6 sur 10. il est aussi sein qu'il garanti une bonne reflexion
